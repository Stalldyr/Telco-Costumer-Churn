...
f"compared to {round(churn_rate_by_contract[1]*100,2)}% for customers with a {churn_rate_by_contract.keys()[1]}-contract ")
f"and {round(churn_rate_by_contract[2]*100,2)}% for customers with a {churn_rate_by_contract.keys()[2]}-contract")
